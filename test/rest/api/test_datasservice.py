...
class DatasServiceTestCase(AbstractRESTTestCase):
    ...
    def test_datas(self):
        ...
        self.check_api(DatasService.get_datas, self.baseuri + "/web/datas.json", HttpMethod.GET,
                       httpretty.Response(body=get_body, status=201))
        entity = PostMyDatasItem()
        entity.type = DataItemType.JSON
        entity.fileName = 'test.json'
        self.check_api(DatasService.post_datas, self.baseuri + "/web/mycontent/datas.json", HttpMethod.POST,
                       httpretty.Response(
    ...
    def test_data(self):
        ...
        self.check_api(DatasService.get_data, self.baseuri + "/web/datas/18220636.json", HttpMethod.GET,
        ...
        self.check_api(DatasService.put_data, self.baseuri + "/web/mycontent/datas/18220636.json", HttpMethod.PUT,
                       httpretty.Response(body='{"succeed":true,"newResourceID":"1"}', status=201), data_id=data_id,
                       entity=entity)
        self.check_api(DatasService.delete_data, self.baseuri + "/web/mycontent/datas/18220636.json",
                       HttpMethod.DELETE,
                       httpretty.Response(body='{"succeed":true}', status=201), data_id=data_id)
        with open('./World.zip', 'rb') as fileb:
            self.check_api(DatasService.upload_data, self.baseuri + "/web/mycontent/datas/18220636/upload.json",
                           HttpMethod.POST,
                           httpretty.Response(
    ...
    def test_data_sharesetting(self):
        data_id = '629565098'
        self.check_api(DatasService.get_data_sharesetting,
        ...
        self.check_api(DatasService.put_data_sharesetting,
